          ...
          <div className={styles.basicDetails}>
            <div className={styles.detailItem}>
              ...
              <span className={styles.time}>
                {formatTime(basicInfo.startTime)} ~ {formatTime(basicInfo.endTime)}
              </span>
            </div>
            ...
            <div className={styles.detailItem}>
              ...
              {basicInfo.locationDetail && <span className={styles.detail}>({basicInfo.locationDetail})</span>}
            </div>
                ...
                {tickets.map((ticket) => (
                  <div key={ticket.ticketId} className={styles.ticketInfoCard}>
                    <div className={styles.ticketDetails}>
                      <h4>{ticket.name}</h4>
                      <p className={styles.ticketType}>{ticket.type === 'EARLY_BIRD' ? '얼리버드' : '일반'}</p>
                ...
                {booths.map((booth) => (
                  <div key={booth.id} className={styles.boothCard}>
                    <div className={styles.boothHeader}>
                      <h4>{booth.name}</h4>
                      <span className={styles.boothNumber}>부스 #{booth.boothNumber}</span>
                      {booth.isPremium && <span className={styles.premiumBadge}>프리미엄</span>}
                    </div>
                    <div className={styles.boothContent}>
                      ...
                      <p className={styles.boothDescription}>{booth.description || '부스 설명이 없습니다.'}</p>
                      ...
                      <div key={review.reviewId} className={styles.reviewCard}>
                        <div className={styles.reviewHeader}>
                          <div className={styles.reviewerInfo}>
                            ...
                            {review.isMyReview && <span className={styles.myReviewBadge}>내 리뷰</span>}
                          </div>
