// src/pages/MessageTemplateList.jsx
...
const dummyTemplates = [
    {
        ...
        title: '박람회 신청 승인 알림',
        content:
            '안녕하세요. 귀하의 박람회 신청이 승인되었습니다. 자세한 내용은 첨부파일을 확인해주세요. 아아아아아아아아아아아아아아아아아아',
    ...
    return (
        <main className={styles.container}>
            <div className={styles.headerSection}>
                <h1 className={styles.title}>발송 메시지 관리</h1>
                <div className={styles.searchCreateWrap}>
                    <input className={styles.searchInput} placeholder="템플릿 검색..." />
                    <Link to="/platform/admin/settingMessage/new">
                        <button className={styles.createButton}>새 템플릿 생성</button>
                    </Link>
                </div>
            </div>
            ...
            <div className={styles.listSection}>
                {dummyTemplates.map((template) => (
                    <Link to={`/platform/admin/settingMessage/${template.id}`}>
                        <div key={template.id} className={styles.card}>
                            ...
                            <div className={styles.editRow}>
                                ...
                                }} className={styles.editButton}>편집</button>
